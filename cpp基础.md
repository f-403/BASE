...
1. [关于CPP所有](#关于cpp所有)
	1. [基础](#基础)
      	1. [打印16进制](#打印16进制)
      	2. [限制cin输入长度](#限制cin输入长度)
      	3. [头文件中的最大值与最小值](#头文件中的最大值与最小值)
      	4. [字符串](#字符串)
      	5. [getline与get](#getline与get)
      	6. [当getline或cin错误时](#当getline或cin错误时)
      	7. [字符串与C-style风格](#字符串与c-style风格)
      	8. [结构体](#结构体)
      	9.  [枚举](#枚举)
      	10. [new与delete](#new与delete)
      	11. [数组替代品](#数组替代品)
      	12. [数组类](#数组类)
      	13. [数组](#数组)
      	14. [cin读取到特定字符再退出1](#cin读取到特定字符再退出1)
      	15. [读取到特定字符再退出2](#读取到特定字符再退出2)
      	16. [打开文件](#打开文件)
      	17. [指针](#指针)
      	18. [函数与array对象](#函数与array对象)
      	19. [用ifstream向字符串写数据](#用ifstream向字符串写数据)
      	20. [函数重载问题](#函数重载问题)
      	21. [函数模板](#函数模板)
	2.  [类](#类)
           1. [如果一个函数的参数为一个父类的引用， 可以传它的子类的引用进去](#如果一个函数的参数为一个父类的引用-可以传它的子类的引用进去)
           2. [父类构造函数与析构函数对于子类的作用](#父类构造函数与析构函数对于子类的作用)
           3. [复制构造函数](#复制构造函数)
           4. [虚函数与纯虚函数](#虚函数与纯虚函数)
           5. [友元函数](#友元函数)
           6. [运算符重载](#运算符重载)
           7. [类中的转换函数， 比如一个类stu, 你想要int a = stu, 相当于把stu转换为int类型](#类中的转换函数-比如一个类stu-你想要int-a--stu-相当于把stu转换为int类型)
	3.  [指针](#指针-1)
           1. [智能指针](#智能指针)
